...
const httpOptions = {
  headers: new HttpHeaders({
    ...
    'user-key': '12c7116211a3adfcd252bb6062b3ab27'
  })
};
...
//getRestList(position): Array<Restaurant>{
  //return this.httpClient.get<ResData>(this.api_url+'/geocode?lat=12.8991743&lon=77.605295',httpOptions).pipe(map(
//return this.httpClient.get<ResData>(this.api_url+'/geocode?lat='+position.coords.latitude+'&lon='+position.coords.longitude,httpOptions).pipe(map(
//    (response:ResData)=>
//    {
